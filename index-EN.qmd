...
```
:::
-   The course achieved a completion rate of 27%, exceeding the typical completion rates reported in the literature, which range between 7% and 10% (Fu et al., 2021; Gütl et al., 2014), and even surpassing the highest reported rates of 25% (Jordan, 2015; Duncan et al., 2022).
- The qualitative analysis revealed that **over 80% of course participants agreed that the course met its stated objectives and addressed regional needs in terms of capacity building in data science and infectious disease modelling**.

- Overall, the course received a **rating of 4.7 out of 5.0**.
