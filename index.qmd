...
la Universidad de los Andes en Colombia, el London School of Hygiene and
Tropical Medicine en Reino Unido, el Medical Research Council Unit en
Gambia, y data.org. Proyecto patrocinado por el IDRC de Canadá.
...
-   Inscripciones abiertas a la primera implementación del **Curso en
    ciencia de datos en salud pública y modelamiento de enfermedades
    infecciosas**

    **Link al formulario de
    inscripción [Aquí](https://edge.edx.org/courses/course-v1:javeriana+000645+2023/about)**
:::
...
el 15 de octubre y 15 de diciembre de 2024 con un grupo de hasta 1000
personas en América Latina y el Caribe. Para esta implementación se
tendrán disponibles 10 unidades de aprendizaje en temas de Teoría
Epidémica, Modelamiento Matemático y el uso del lenguaje de programación
R para la limpieza y análisis de datos epidemiológicos.

Información importante de la primera implementación del del curso
**"Ciencia de Datos en Salud Pública y Modelamiento de Enfermedades
Infecciosas"**

-   **Inscripciones:** 16 de septiembre al 11 de octubre de 2024

-   **Inicio del curso:** 15 de octubre de 2024

-   **Finalización:** 15 de diciembre de 2024

-   **Dirigido a:** Profesionales y estudiantes del sector de la salud y
    las áreas STEM así como personas involucradas en la toma de
    decisiones en salud pública en América Latina y el Caribe.

-   **Modalidad:** Virtual, asincrónico a través de la plataforma edX
    Edge
...
-   **Link al formulario de inscripción:
     [Aquí](https://edge.edx.org/courses/course-v1:javeriana+000645+2023/about)**
