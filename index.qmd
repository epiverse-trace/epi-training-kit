...
y el Caribe. Para esta implementación, se ofreció el curso 
**"Ciencia de Datos en Salud Pública y Modelamiento de Enfermedades 
Infecciosas"** en modalidad virtual y asincrónica. El curso conto con 10
...
de género, y tuvo una duración aproximada de 30 horas. El curso
...
-   **Más de la mitad de los participantes tenía un título de
    ...
    doctorado y personas que reportaron eduación secundaria y bachiller.
...
-   26% (554 participantes) del total de inscritos completaron y aprobaron el curso exitosamente.
-   El 51% de los participantes que completaron el curso tenían entre 31 y 45 años, 
seguido por el grupo de **18 a 30 años**.
-  Los participantes que completaron el curso provenian principalmente de 
Colombia (59%), Panamá (6%) y Perú (6%). 
- El 90% de participantes que completaron el curso provenian de zona urbana. 
...
y el 10% Ingenería.
- El 61% de participantes que completaron el curso trabaja en el sector Salud, 
el 23% educación y el 7% Tecnología.
...
- El 46% de participantes que completaron el curso perciben su experiencia en los temas
 del curso como "Intermedio: He recibido formación sobre este tema anteriormente;
o estoy aquí para refrescar mis conocimientos sobre este tema." y seguido del 40%
 perciben su experiencia en los temas del curso como Principiante: He recibido 
formación en temas relevantes, pero soy nuevo en este tema en particular.
...
-   En octubre de 2024 se realizó la primera implementación y evaluación del curso online
    masivo abierto titulado **"Ciencia de Datos en Salud Pública y Modelamiento de Enfermedades 
...
-   Se promovido la formación de mujeres, con una
    participación de cerca del 50%. 
