...
y el Caribe. Para esta implementación, estuvieron disponibles 10
...
para la limpieza y análisis de datos epidemiológicos. Durante esta
fase, se ofreció el curso **"Ciencia de Datos en Salud Pública y
Modelamiento de Enfermedades Infecciosas"** en modalidad virtual y
asincrónica. Este curso fue gratuito, en español, con perspectiva
...
-   **El grupo incluyó participantes de áreas STEM (27%), salud (70%) y otras disciplinas (3%)**, con
    niveles variados de formación.
-   **Cerca de la mitad de los participantes tenía un título de
    maestría**. Sin embargo también participaron personas con pregrado,
    doctorado y .
-   La mayoría de los participantes que aprobaron el curso tenían entre 31 y 45 años, seguido por el grupo de **18 a 30 años**.
