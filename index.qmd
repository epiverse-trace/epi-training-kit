...
>
> ### **Estrategia de entrenamiento online de acceso abierto en modelamiento de enfermedades infecciosas y ciencia de datos en salud pública**
...
[Aquí](https://forms.office.com/r/36qWp9YU6U)
:::
...
regional. Por ello, esta estrategia de entrenamiento e-learning busca
superar estas barreras ofreciendo educación de acceso abierto y de alta
calidad a través de un MOOC (Curso Masivo Abierto en Línea, por sus
siglas en inglés "Massive Open Online Course"), promoviendo además la
equidad de género en estos campos para garantizar un desarrollo más
inclusivo y efectivo en la respuesta a emergencias de salud pública en
la región.

## **Objetivo**

El objetivo principal de esta estrategia es proporcionar material
educativo de acceso abierto en español, adaptado específicamente al
contexto de América Latina y el Caribe, con el fin de desarrollar
capacidades en la región en ciencia de datos y modelamiento matemático
...
ingeniería y matemáticas), así como a personas involucradas en la toma
de decisiones en salud pública.

## **Contenidos**

Para la construcción de esta estrategia se tiene contemplado el
desarrollo de un MOOC (Curso Masivo Abierto en Línea, por sus siglas en
inglés "Massive Open Online Course") que contiene unidades cortas de
aprendizaje agrupadas en cuatro módulos principales:
